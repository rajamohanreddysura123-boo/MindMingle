...
async function sendInvoiceEmail(invoice) {
    const money = (minor) => (0, invoices_1.formatAmount)(minor, invoice.symbol, invoice.decimals);
    ...
    const taxRows = invoice.taxComponents.map((component) => ({
        label: `${component.label} (${(0, tax_1.formatRate)(component.rate)})`,
